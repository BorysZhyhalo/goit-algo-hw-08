...
def min_connect_cost(cables):
    ...
    while len(cables) > 1:
        cable1 = heapq.heappop(cables)  # найкоротший
        cable2 = heapq.heappop(cables)  # другий найкоротший

        combined = cable1 + cable2
        total_cost += combined

        heapq.heappush(cables, combined)  # новий кабель назад у купу
